...
function createBaseSignatureAndData(): SignatureAndData {
  return {
    ...
    dataType: DataType.DATA_TYPE_UNINITIALIZED_UNSPECIFIED,
...
export const SignatureAndData: MessageFns<SignatureAndData> = {
  encode(message: SignatureAndData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.dataType !== DataType.DATA_TYPE_UNINITIALIZED_UNSPECIFIED) {
      writer.uint32(16).int32(dataTypeToNumber(message.dataType));
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.dataType = dataTypeFromJSON(reader.int32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromPartial<I extends Exact<DeepPartial<SignatureAndData>, I>>(object: I): SignatureAndData {
    const message = createBaseSignatureAndData();
    message.signature = object.signature ?? new Uint8Array(0);
    message.dataType = object.dataType ?? DataType.DATA_TYPE_UNINITIALIZED_UNSPECIFIED;
...
export const SignBytes: MessageFns<SignBytes> = {
  encode(message: SignBytes, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.dataType !== DataType.DATA_TYPE_UNINITIALIZED_UNSPECIFIED) {
      writer.uint32(32).int32(dataTypeToNumber(message.dataType));
    }
    if (message.data.length !== 0) {
