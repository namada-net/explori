...
export function packetDirectionToNumber(object: PacketDirection): number {
  switch (object) {
    case PacketDirection.PACKET_SEND:
      return 0;
    case PacketDirection.PACKET_RECV:
...
export const HourEpoch: MessageFns<HourEpoch> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.epochNumber = reader.uint64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
        ...
        case 4: {
          ...
          message.epochStartHeight = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HourEpoch {
    return {
      epochNumber: isSet(object.epochNumber) ? globalThis.String(object.epochNumber) : "0",
      duration: isSet(object.duration) ? Duration.fromJSON(object.duration) : undefined,
      epochStartTime: isSet(object.epochStartTime) ? fromJsonTimestamp(object.epochStartTime) : undefined,
      epochStartHeight: isSet(object.epochStartHeight) ? globalThis.String(object.epochStartHeight) : "0",
    };
  },
