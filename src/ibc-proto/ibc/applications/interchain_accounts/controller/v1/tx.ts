...
import { Order, orderFromJSON, orderToJSON, orderToNumber } from "../../../../core/channel/v1/channel";
...
function createBaseMsgRegisterInterchainAccount(): MsgRegisterInterchainAccount {
  return { owner: "", connectionId: "", version: "", ordering: Order.ORDER_NONE_UNSPECIFIED };
}
...
export const MsgRegisterInterchainAccount: MessageFns<MsgRegisterInterchainAccount> = {
  encode(message: MsgRegisterInterchainAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.ordering !== Order.ORDER_NONE_UNSPECIFIED) {
      writer.uint32(32).int32(orderToNumber(message.ordering));
    }
    return writer;
  },
...
export const MsgSendTx: MessageFns<MsgSendTx> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.relativeTimeout = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): MsgSendTx {
    return {
      ...
      relativeTimeout: isSet(object.relativeTimeout) ? globalThis.String(object.relativeTimeout) : "0",
    };
  },
