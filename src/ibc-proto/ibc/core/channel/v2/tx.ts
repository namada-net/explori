...
export function responseResultTypeToNumber(object: ResponseResultType): number {
  switch (object) {
    case ResponseResultType.RESPONSE_RESULT_TYPE_UNSPECIFIED:
      return 0;
    case ResponseResultType.RESPONSE_RESULT_TYPE_NOOP:
...
function createBaseMsgRecvPacketResponse(): MsgRecvPacketResponse {
  return { result: ResponseResultType.RESPONSE_RESULT_TYPE_UNSPECIFIED };
}
...
export const MsgRecvPacketResponse: MessageFns<MsgRecvPacketResponse> = {
  encode(message: MsgRecvPacketResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== ResponseResultType.RESPONSE_RESULT_TYPE_UNSPECIFIED) {
      writer.uint32(8).int32(responseResultTypeToNumber(message.result));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.result = responseResultTypeFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRecvPacketResponse>, I>>(object: I): MsgRecvPacketResponse {
    const message = createBaseMsgRecvPacketResponse();
    message.result = object.result ?? ResponseResultType.RESPONSE_RESULT_TYPE_UNSPECIFIED;
    return message;
  },
};
