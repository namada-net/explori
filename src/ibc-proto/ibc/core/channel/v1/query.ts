  ...
  fromJSON(object: any): QueryPacketAcknowledgementsRequest {
    return {
      ...
      packetCommitmentSequences: globalThis.Array.isArray(object?.packetCommitmentSequences)
        ? object.packetCommitmentSequences.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): QueryUnreceivedAcksRequest {
    return {
      ...
      packetAckSequences: globalThis.Array.isArray(object?.packetAckSequences)
        ? object.packetAckSequences.map((e: any) => globalThis.String(e))
        : [],
    };
  },
...
export const QueryNextSequenceReceiveResponse: MessageFns<QueryNextSequenceReceiveResponse> = {
  ...
  fromJSON(object: any): QueryNextSequenceReceiveResponse {
    return {
      nextSequenceReceive: isSet(object.nextSequenceReceive) ? globalThis.String(object.nextSequenceReceive) : "0",
      proof: isSet(object.proof) ? bytesFromBase64(object.proof) : new Uint8Array(0),
      proofHeight: isSet(object.proofHeight) ? Height.fromJSON(object.proofHeight) : undefined,
    };
  },
...
export const QueryNextSequenceSendResponse: MessageFns<QueryNextSequenceSendResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.nextSequenceSend = reader.uint64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): QueryNextSequenceSendResponse {
    return {
      nextSequenceSend: isSet(object.nextSequenceSend) ? globalThis.String(object.nextSequenceSend) : "0",
      proof: isSet(object.proof) ? bytesFromBase64(object.proof) : new Uint8Array(0),
      proofHeight: isSet(object.proofHeight) ? Height.fromJSON(object.proofHeight) : undefined,
    };
  },
