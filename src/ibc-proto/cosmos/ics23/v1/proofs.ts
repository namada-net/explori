...
export function hashOpToNumber(object: HashOp): number {
  switch (object) {
    case HashOp.NO_HASH:
      return 0;
    case HashOp.SHA256:
...
export function lengthOpToNumber(object: LengthOp): number {
  switch (object) {
    case LengthOp.NO_PREFIX:
      return 0;
    case LengthOp.VAR_PROTO:
...
export const LeafOp: MessageFns<LeafOp> = {
  encode(message: LeafOp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hash !== HashOp.NO_HASH) {
      writer.uint32(8).int32(hashOpToNumber(message.hash));
    }
    if (message.prehashKey !== HashOp.NO_HASH) {
      writer.uint32(16).int32(hashOpToNumber(message.prehashKey));
    }
    if (message.prehashValue !== HashOp.NO_HASH) {
      writer.uint32(24).int32(hashOpToNumber(message.prehashValue));
    }
    if (message.length !== LengthOp.NO_PREFIX) {
      writer.uint32(32).int32(lengthOpToNumber(message.length));
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.hash = hashOpFromJSON(reader.int32());
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.prehashKey = hashOpFromJSON(reader.int32());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.prehashValue = hashOpFromJSON(reader.int32());
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.length = lengthOpFromJSON(reader.int32());
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): LeafOp {
    return {
      hash: isSet(object.hash) ? hashOpFromJSON(object.hash) : HashOp.NO_HASH,
      prehashKey: isSet(object.prehashKey) ? hashOpFromJSON(object.prehashKey) : HashOp.NO_HASH,
      prehashValue: isSet(object.prehashValue) ? hashOpFromJSON(object.prehashValue) : HashOp.NO_HASH,
      length: isSet(object.length) ? lengthOpFromJSON(object.length) : LengthOp.NO_PREFIX,
  ...
  fromPartial<I extends Exact<DeepPartial<LeafOp>, I>>(object: I): LeafOp {
    const message = createBaseLeafOp();
    message.hash = object.hash ?? HashOp.NO_HASH;
    message.prehashKey = object.prehashKey ?? HashOp.NO_HASH;
    message.prehashValue = object.prehashValue ?? HashOp.NO_HASH;
    message.length = object.length ?? LengthOp.NO_PREFIX;
...
function createBaseInnerOp(): InnerOp {
  return { hash: HashOp.NO_HASH, prefix: new Uint8Array(0), suffix: new Uint8Array(0) };
}
...
export const InnerSpec: MessageFns<InnerSpec> = {
  encode(message: InnerSpec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hash !== HashOp.NO_HASH) {
      writer.uint32(48).int32(hashOpToNumber(message.hash));
    }
    return writer;
  },
